...
from dictionary import PROTOCOL
from dictionary.connection import DictionaryConnection
...
class DictionaryProtocol(Protocol, ProtocolInterfacePresence):
    ...
    def create_connection(self, connection_manager, parameters):
        return DictionaryConnection(self, connection_manager, parameters)
